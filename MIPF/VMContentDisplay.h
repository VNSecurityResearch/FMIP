	...
	public wxDialog
{
	...
	//friend class MIPF_TextCtrl;
private:
	wxStatusBar* m_ptrStatusBar;
	ThreadingOutputVMContent* m_ptrAttachedThread = nullptr;
	MIPF_TextCtrl* m_ptrTextCtrl = nullptr;
	wxButton* m_ptrButtonOK;
	MIPF_TreeCtrl* m_ptrTreeCtrl;
	HWND m_hWndButtonOK;
	OUTPUT_TYPE m_OutputType;
public:
	VMContentDisplay(MainWindow*, MIPF_TreeCtrl*, OUTPUT_TYPE, const wxString& Title = wxT(""), wxWindowID = wxID_ANY);
	~VMContentDisplay();
