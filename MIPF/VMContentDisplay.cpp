...
VMContentDisplay::VMContentDisplay(MainWindow* Parent, MIPF_TreeCtrl* ptrTreeCtrl, OUTPUT_TYPE OutputType, const wxString& Title, wxWindowID WindowID)
	:wxDialog(Parent, WindowID, Title, wxDefaultPosition, wxSize(550, 640), wxDEFAULT_DIALOG_STYLE | wxDIALOG_NO_PARENT | wxMAXIMIZE_BOX | wxMINIMIZE_BOX | wxRESIZE_BORDER), m_ptrTreeCtrl(ptrTreeCtrl)
{
	...
	this->m_ptrTextCtrl = new MIPF_TextCtrl(this);
	wxTextAttr TextAttr;
